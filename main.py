...
# Refer to 'gather_info' in order to properly place website identification.
...
def gather_info(name, url, host):
    ...
    html = getHttp(url)
    create_report(name, url, domain_name, nmap, robots_txt, whois, html)


def create_report(name, full_url, domain_name, nmap, robots_txt, whois, html):
    ...
    # Performs Html scrape.
    write_file(project_dir + 'html.txt', html)
